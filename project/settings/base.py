...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SubTrack API',
    'DESCRIPTION': 'Easily track, manage, and never miss a subscription payment again. Stay in control of your expenses with one simple tool.',
    'VERSION': '1.0.0',
...
SIMPLE_JWT = {
    ...
    'AUTH_COOKIE_HTTPONLY' : True,  # Http only cookie flag.It's not fetch by javascript.
